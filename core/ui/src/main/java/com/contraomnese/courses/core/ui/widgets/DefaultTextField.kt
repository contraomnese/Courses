...
import androidx.compose.runtime.getValue
import com.contraomnese.courses.core.design.theme.cornerRadius28
                ...
                TextFieldDefaults.DecorationBox(
                    ...
                    container = {
                        TextFieldDefaults.Container(
                            ...
                            colors = colors,
                            interactionSource = interactionSource,
                            shape = RoundedCornerShape(cornerRadius28),
                            focusedIndicatorLineThickness = thickness2,
                            unfocusedIndicatorLineThickness = thickness1
                        )
                    }
                )
            }
...
private fun defaultFieldColors() = TextFieldDefaults.colors(
    focusedContainerColor = MaterialTheme.colorScheme.surface.copy(0.2f),
    unfocusedContainerColor = MaterialTheme.colorScheme.surface.copy(0.2f),
...
private fun TextFieldPlaceholderPreview() {
    CoursesTheme {
        DefaultTextField(
            modifier = Modifier.height(itemHeight40),
            value = "",
            onValueChanged = {},
            isError = false,
            singleLine = true,
